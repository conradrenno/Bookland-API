...
public class UpdateCartItemService implements UpdateCartItemUseCase {
    ...
    private UpdateCartItemService(CartPersistencePort cartPersistencePort, BookInfoPort bookInfoPort) {
        this.cartPersistencePort = cartPersistencePort;
        this.bookInfoPort = bookInfoPort;
    }

    public static UpdateCartItemService create(CartPersistencePort cartPersistencePort, BookInfoPort bookInfoPort) {
        return new UpdateCartItemService(cartPersistencePort, bookInfoPort);
    }
