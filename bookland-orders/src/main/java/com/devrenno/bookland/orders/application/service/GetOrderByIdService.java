...
public class GetOrderByIdService implements GetOrderByIdUseCase {
    ...
    private GetOrderByIdService(OrderPersistencePort orderPersistencePort) {
        this.orderPersistencePort = orderPersistencePort;
    }

    public static GetOrderByIdService create(OrderPersistencePort orderPersistencePort) {
        return new GetOrderByIdService(orderPersistencePort);
    }
